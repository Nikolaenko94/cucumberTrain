 ...
 */
export declare class TargetElements extends Question<ElementArrayFinder> implements MetaQuestion<Question<ElementFinder> | ElementFinder, ElementArrayFinder> {
     ...
     * @see {@link @serenity-js/core/lib/screenplay/questions~List}
     */
    where<Answer_Type>(question: MetaQuestion<ElementFinder, Promise<Answer_Type> | Answer_Type>, expectation: Expectation<any, Answer_Type>): List<ElementArrayFinderListAdapter, ElementFinder, ElementArrayFinder>;
    /**
     * @desc
