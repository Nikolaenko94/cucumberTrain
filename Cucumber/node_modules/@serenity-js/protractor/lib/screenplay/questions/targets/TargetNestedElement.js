...
class TargetNestedElement extends core_1.Question {
     ...
     */
    answeredBy(actor) {
        return withAnswerOf_1.withAnswerOf(actor, this.parent, parent => withAnswerOf_1.withAnswerOf(actor, this.child, child => override_1.override(parent.element(child.locator()), 'toString', TargetNestedElement.prototype.toString.bind(this))));
    }
}
