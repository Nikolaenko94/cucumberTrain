...
exports.TargetNestedElements = void 0;
...
class TargetNestedElements extends core_1.Question {
     ...
     */
    answeredBy(actor) {
        return withAnswerOf_1.withAnswerOf(actor, this.parent, parent => withAnswerOf_1.withAnswerOf(actor, this.children, children => override_1.override(parent.all(children.locator()), 'toString', TargetNestedElements.prototype.toString.bind(this))));
    }
}
exports.TargetNestedElements = TargetNestedElements;
//# sourceMappingURL=TargetNestedElements.js.map